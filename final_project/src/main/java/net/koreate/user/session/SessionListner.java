...
public class SessionListner implements HttpSessionListener, HttpSessionAttributeListener {
	...
	public SessionListner() {
		System.out.println("sessionEventListner 积己");
	...
	public void attributeAdded(HttpSessionBindingEvent event) {
		System.out.println("attributeAdded 龋免");
		System.out.println("sessionID : "+event.getSession().getId());
		System.out.println("session俊 眠啊等 attribute name : "+event.getName()+event.getValue());
...
//		System.out.println("remove session : "+event.getSession().getId());
	...
	public void sessionCreated(HttpSessionEvent se) {
		System.out.printf("session 积己 id %s %n ",se.getSession().getId());
	}

	@Override
	public void sessionDestroyed(HttpSessionEvent se) {
//		System.out.printf("Session 昏力 session id %s %n,",se.getSession().getId());
